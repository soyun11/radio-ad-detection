...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="Split movie radio MP3 into sliding-window clips"
    )
    parser.add_argument("date", type=str, help="Date (YYYYMMDD)")
    parser.add_argument(
        "--output_dir", type=str, default=None,
        help="Directory to save clips (default: clips_movie/<date>)"
    )
    parser.add_argument(
    ...
    output_dir = args.output_dir or join("clips_movie", date)
